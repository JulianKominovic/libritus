...
/**
 * Copied from @anaralabs/lector
 * https://github.com/anaralabs/lector/blob/main/packages/lector/src/components/selection-tooltip.tsx
 * @param param0
 * @see https://github.com/anaralabs/lector/blob/main/packages/lector/src/components/selection-tooltip.tsx
 */

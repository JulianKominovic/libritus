  ...
  return (
    ...
    >
      <div className="relative rounded-md bg-muted/50">
        <pre className="overflow-x-hidden whitespace-pre-wrap break-all p-8 pr-4 font-mono text-sm leading-[normal] [tab-size:2] print:break-inside-avoid">
  ...
  return (
    ...
    >
      ...
      {hasCopied ? (
        ...
        <DynamicIcon name="copy" className="!size-3" />
      )}
    </Button>
  )
}

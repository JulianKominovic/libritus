...
> = {
  ...
  custom: {
    outline: <DynamicIcon name="star" className="size-full" />,
    solid: <DynamicIcon name="star" className="size-full" />
  },

  flags: {
    outline: <DynamicIcon name="flag" className="size-full" />,
    solid: <DynamicIcon name="flag" className="size-full" />
  },

  foods: {
    outline: <DynamicIcon name="apple" className="size-full" />,
    solid: <DynamicIcon name="apple" className="size-full" />
  },

  frequent: {
    outline: <DynamicIcon name="clock" className="size-full" />,
    solid: <DynamicIcon name="clock" className="size-full" />
  },

  nature: {
    outline: <DynamicIcon name="leaf" className="size-full" />,
    solid: <DynamicIcon name="leaf" className="size-full" />
  },

  objects: {
    outline: <DynamicIcon name="lightbulb" className="size-full" />,
    solid: <DynamicIcon name="lightbulb" className="size-full" />
  },

  people: {
    outline: <DynamicIcon name="smile" className="size-full" />,
    solid: <DynamicIcon name="smile" className="size-full" />
  },

  places: {
    outline: <DynamicIcon name="compass" className="size-full" />,
    solid: <DynamicIcon name="compass" className="size-full" />
  },

  symbols: {
    outline: <DynamicIcon name="music" className="size-full" />,
    solid: <DynamicIcon name="music" className="size-full" />
  }
}

const emojiSearchIcons = {
  delete: <DynamicIcon name="x" className="size-4 text-current" />,
  loupe: <DynamicIcon name="search" className="size-4 text-current" />
}

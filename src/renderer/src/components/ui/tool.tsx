  ...
  const getStateIcon = () => {
    switch (state) {
      case 'input-streaming':
        return <DynamicIcon name="loader-2" className="h-4 w-4 animate-spin text-blue-500" />
      case 'input-available':
        return <DynamicIcon name="settings" className="h-4 w-4 text-orange-500" />
      case 'output-available':
        return <DynamicIcon name="check-circle" className="h-4 w-4 text-green-500" />
      case 'output-error':
        return <DynamicIcon name="x-circle" className="h-4 w-4 text-red-500" />
      default:
        return <DynamicIcon name="settings" className="text-muted-foreground h-4 w-4" />
    }
  }
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger asChild>
          ...
          >
            ...
            <DynamicIcon name="chevron-down" className={cn('h-4 w-4', isOpen && 'rotate-180')} />
          </Button>
        </CollapsibleTrigger>
        <CollapsibleContent
          className={cn(

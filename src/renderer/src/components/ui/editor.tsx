...
const editorContainerVariants = cva(
  'relative w-full cursor-text caret-primary select-text selection:bg-primary/25 focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border-none [&_.slate-selection-area]:border-transparent [&_.slate-selection-area]:bg-transparent',
  {
    defaultVariants: {
      variant: 'default'
    },
...
export function EditorContainer({
  ...
  return (
    <PlateContainer
      className={cn(
        'ignore-click-outside/toolbar relative',
  ...
  ({ className, disabled, focused, variant, ...props }, ref) => {
    return (
      <PlateContent
        ...
        data-ignore-global-paste-event
        data-note-card-content
        {...props}
      />
    )
  }

            ...
            <PopoverTrigger asChild>
              ...
              >
                {suggestionsCount > 0 && discussionsCount === 0 && (
                  <DynamicIcon name="pencil-line" className="size-4 shrink-0" />
                )}

                {suggestionsCount === 0 && discussionsCount > 0 && (
                  <DynamicIcon name="message-square-text" className="size-4 shrink-0" />
                )}

                {suggestionsCount > 0 && discussionsCount > 0 && (
                  <DynamicIcon name="messages-square" className="size-4 shrink-0" />
                )}

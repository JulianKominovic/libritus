...
function HighlightCardsTemplate({
  ...
  const deleteCommentFromHighlight = usePdfs(
    (s) => s.deleteCommentFromHighlight
  );
          ...
          <ContextMenu key={highlight.id}>
            <ContextMenuTrigger asChild>
              ...
              >
                ...
                <pre
                  className={
                    "cursor-pointer rounded-xl overflow-clip p-2 w-full font-serif border whitespace-pre-wrap text-left text-sm select-none"
                  }
                  style={{
            ...
            <ContextMenuContent>
              ...
              >
                <DynamicIcon
                  name="trash"
                  className="size-4 text-morphing-900"
                />
                <p>Delete</p>
              </ContextMenuItem>
            </ContextMenuContent>

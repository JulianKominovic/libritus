...
| **Click center**           | Activate embed → Plate editable (`activeEmbeddable`). On hover (inactive), a centered “Click to edit” pill appears (constant screen size vs canvas zoom).                                                                                                                                                                                                    |
